...
public class TransferAndAssignActivity extends BaseActivity {
    ...
    private TextView tvLab, tvLabName, tvSerialNumber, tvName, tvEPC, tvRSSI, txtIndicator, tvRfidLabel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvRfidLabel = findViewById(R.id.tvRfidLabel);
    ...
    public void onInventoryTag(in.mobiux.android.orca50scanner.reader.model.Inventory inventory) {
        ...
        if (matchingAsset != null) {
            Inventory tag = new Inventory();

            tag.setInventoryId(inventory.getInventoryId());
            tag.setEpc(inventory.getEpc());
            tag.setRssi(inventory.getRssi());

            scannedTags.put(inventory.getFormattedEPC(), tag);
...
//        super.onInventoryTagEnd(tagEnd);
    ...
    private void updateUI(Inventory selectedAsset) {
        if (selectedAsset != null) {
            ...
            tvRfidLabel.setText("" + selectedAsset.getRfidLabelName());
